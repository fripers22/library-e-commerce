...
class UserDB(Base):
	...
	contraseña = Column(String, nullable=False)  # Hasheada
	rol = Column(String, nullable=False, default="CLIENTE")
	fecha_nacimiento = Column(Date, nullable=False)
	direccion = Column(String, nullable=False)
	telefono = Column(String, nullable=False)
	fecha_creacion = Column(DateTime, default=datetime.utcnow, nullable=False)
	activo = Column(Boolean, default=False, nullable=False)  # Inactivo hasta verificar email
	preferencias = Column(JSON, nullable=True)  # Lista de géneros favoritos
...
class BookDB(Base):
	...
	autor = Column(JSON, nullable=False)  # String o lista de autores
	categoria = Column(JSON, nullable=False)  # String o lista
	precio = Column(String, nullable=False)  # Stored as string for Decimal precision
	...
	descuento = Column(String, nullable=False, default="0")  # Stored as string for Decimal
...
class CarritoDB(Base):
	...
	items = Column(JSON, nullable=False, default=list)  # Lista de items
	fecha_creacion = Column(DateTime, default=datetime.utcnow, nullable=False)
